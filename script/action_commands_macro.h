...
// передача вассалов, освобождение вассалов, передача титулов, создание титулов, разрушение титулов,
// строительство, добавление модификаторов с особыми свойствами (причем может быть несколько одинаковых), 
