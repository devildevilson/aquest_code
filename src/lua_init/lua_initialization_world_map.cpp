...
//         "get_tile", &core::map::get_tile_ptr_lua,
        "set_tile_height", [] (core::map* self, const uint32_t &tile_index, const float &height) {
          self->set_tile_height(FROM_LUA_INDEX(tile_index), height);
        },
        "get_tile_height", [] (core::map* self, const uint32_t &tile_index) {
          return self->get_tile_height(FROM_LUA_INDEX(tile_index));
        },
        "get_tile", [] (core::map* self, const uint32_t &tile_index) {
          return self->get_tile_ptr(FROM_LUA_INDEX(tile_index));
        },
