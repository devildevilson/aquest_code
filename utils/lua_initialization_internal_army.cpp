    ...
    namespace internal {
      void setup_lua_army(sol::state_view lua) {
        ...
        core.new_usertype<core::army>("army", sol::no_constructor,
          ...
          "computed_stats", sol::readonly_property([] (const core::army* self, const uint32_t &index) { return self->stats.get(FROM_LUA_INDEX(index)); }),
          "current_stats", sol::readonly_property([] (const core::army* self, const uint32_t &index) { return self->current_stats.get(FROM_LUA_INDEX(index)); }),
