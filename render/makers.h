#ifndef RENDER_MAKERS_H
#define RENDER_MAKERS_H
...
namespace devils_engine {
  ...
  //     std::vector<DescriptorData> datas;
    ...
    public:
      ...
      descriptor_set_updater & buffer(vk::Buffer buffer, const vk::DeviceSize &offset = 0, const vk::DeviceSize &size = VK_WHOLE_SIZE);
  //     DescriptorUpdater & buffer(Buffer buffer, const VkDeviceSize &offset, const VkDeviceSize &size);
    ...
    public:
      ...
      //pipeline_maker & addShader(const VkShaderStageFlagBits &flag, const std::string &path, const char* name = nullptr);
    ...
    public:
      ...
      render_pass_maker & subpassBegin(const vk::PipelineBindPoint &bind);
