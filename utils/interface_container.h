...
// короче я тут хорошо подумал и решил переделать интерфейс контайнер
// и теперь мне по сути нужна только одна функция, в которой я в общем то все делаю
// у меня сильно сократиться интерфейс контайнер

// было бы неплохо использовать вообще одну входную функцию для интерфейса
// остается вопрос откуда брать данные во время загрузки?
