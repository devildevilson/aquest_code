  ...
  namespace utils {
    namespace internal {
      ...
      static float get_stat(const core::realm* self, const sol::object &obj) {
        const sol::type obj_t = obj.get_type();
        if (obj_t != sol::type::number && obj_t != sol::type::string) throw std::runtime_error("Bad realm stat index obj");
                                                        
        if (obj_t == sol::type::number) {
      ...
      static float get_resource(const core::realm* self, const sol::object &obj) {
        const sol::type obj_t = obj.get_type();
        if (obj_t != sol::type::number && obj_t != sol::type::string) throw std::runtime_error("Bad realm resource index obj");
