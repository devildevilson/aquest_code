...
#define OUTPUT_CHARACTER_TYPE script::character_t
#define OUTPUT_CULTURE_TYPE script::culture_t
#define OUTPUT_RELIGION_TYPE script::religion_t
#define OUTPUT_DYNASTY_TYPE script::dynasty_t
#define OUTPUT_CITY_TYPE2 script::city_t
#define OUTPUT_TITLE_TYPE script::titulus_t
#define OUTPUT_TRAIT_TYPE script::trait_t
#define OUTPUT_PROVINCE_TYPE script::province_t
#define OUTPUT_CULTURE_GROUP_TYPE script::culture_group_t
#define OUTPUT_RELIGION_GROUP_TYPE script::religion_group_t
#define OUTPUT_CITY_TYPE_TYPE script::city_type_t
#define OUTPUT_CASUS_BELLI_TYPE script::casus_belli_t
#define OUTPUT_REALM_TYPE script::realm_t
#define OUTPUT_ARMY_TYPE script::army_t
#define OUTPUT_HERO_TROOP_TYPE script::hero_troop_t
