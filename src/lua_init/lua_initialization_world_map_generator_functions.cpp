...
namespace devils_engine {
  namespace utils {
    static std::string serialize_table(const sol::table &t) {
      //auto creator = global::get<systems::map_t>()->map_creator.get();
      //return creator->serialize_table(t);
      auto gen = global::get<systems::generator_t>()->gen.get();
      return gen->serialize_table(t);
    }
...
//     ADD_FUNC(law)
    ...
    ADD_FUNC(character)
//     ADD_FUNC(dynasty)
    ADD_FUNC(casus_belli)
    ADD_FUNC(decision)
    ADD_FUNC(interaction)
    ADD_FUNC(event)
...
//     LOAD_FUNC(law)
    ...
    LOAD_FUNC(character)
//     LOAD_FUNC(dynasty)
    LOAD_FUNC(casus_belli)
    LOAD_FUNC(decision)
    LOAD_FUNC(interaction)
    LOAD_FUNC(event)
...
//       LOAD_FUNC("load_titles", add_title)
      ...
      SET_UTILS_ADD_FUNC(trait)
      SET_UTILS_ADD_FUNC(casus_belli)
      ...
      SET_UTILS_LOAD_FUNC(trait)
      SET_UTILS_LOAD_FUNC(casus_belli)
