...
//           "clergy", sol::readonly(&core::realm::clergy),
          ...
          "get_stat", [] (const core::realm* self, const sol::object &obj) {
          ...
          "get_base_stat", [] (const core::realm* self, const sol::object &obj) {
            if (obj.get_type() != sol::type::number && obj.get_type() != sol::type::string) throw std::runtime_error("Bad realm stat index obj");
          ...
          "get_resource", [] (const core::realm* self, const sol::object &obj) {
          ...
          "has_right", [] (const core::realm* self, const sol::object &obj) {
