...
//       troop* troops;
      ...
      script::city_type_t get_city_type() const;
      // когда овнера может не быть? когда это разрушенная пустая провка (ее еще нужно колонизировать)
      script::character_t get_direct_owner() const;
    };
