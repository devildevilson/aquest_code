...
//     }
    ...
    script::titulus_t city::get_title() const {
      return title;
    }
    
    script::city_type_t city::get_city_type() const {
      return type;
    }
    
    script::character_t city::get_direct_owner() const {
      auto o = title->owner;
      return o.valid() ? o->leader : nullptr;
    }
