...
#define STAT_FUNC(val) MAKE_MAP_PAIR(core::character_stats, val),
#define CHARACTER_PENALTY_STAT_FUNC(val) MAKE_MAP_PAIR(core::character_stats, val##_penalty),
