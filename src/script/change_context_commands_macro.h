...
#define CHARACTER_CHANGE_CONTEXT_COMMANDS_LIST \
  ...
  CHANGE_CONTEXT_COMMAND_FUNC(love_acquaintance, INPUT_CHARACTER, INPUT_CHARACTER, OUTPUT_NOTHING) \
  CHANGE_CONTEXT_COMMAND_FUNC(neutral_acquaintance, INPUT_CHARACTER, INPUT_CHARACTER, OUTPUT_NOTHING) \
  ...
  CHANGE_CONTEXT_COMMAND_FUNC(war, INPUT_CHARACTER, INPUT_WAR, OUTPUT_NOTHING) \
  CHANGE_CONTEXT_COMMAND_FUNC(war_ally, INPUT_CHARACTER, INPUT_CHARACTER, OUTPUT_NOTHING) \
  CHANGE_CONTEXT_COMMAND_FUNC(war_enemy, INPUT_CHARACTER, INPUT_CHARACTER, OUTPUT_NOTHING) \
  CHANGE_CONTEXT_COMMAND_FUNC(ally, INPUT_CHARACTER, INPUT_CHARACTER, OUTPUT_NOTHING) \
  CHANGE_CONTEXT_COMMAND_FUNC(truce_holder, INPUT_CHARACTER, INPUT_CHARACTER, OUTPUT_NOTHING) /* все персонажи у которых перемеирие с этим персонажем (в моем случае реалмы) */ \
  CHANGE_CONTEXT_COMMAND_FUNC(truce_target, INPUT_CHARACTER, INPUT_CHARACTER, OUTPUT_NOTHING) /* все перемирия этого персонажа (в моем случае реалма) */ \
