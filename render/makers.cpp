...
namespace devils_engine {
  ...
  //   }
    ...
    descriptor_set_updater & descriptor_set_updater::buffer(vk::Buffer buffer, const vk::DeviceSize &offset, const vk::DeviceSize &size) {
    ...
    pipeline_maker::pipeline_maker(vk::Device* device) : device(device) {
      ...
      defaultBlending = vk::PipelineColorBlendAttachmentState(
        VK_TRUE,
  //       vk::_BLEND_FACTOR_SRC_COLOR,
        vk::BlendFactor::eSrcAlpha,
  //       vk::_BLEND_FACTOR_ONE_MINUS_DST_COLOR,
        vk::BlendFactor::eOneMinusSrcAlpha,
        vk::BlendOp::eAdd,
        vk::BlendFactor::eSrcAlpha,
  //       vk::_BLEND_FACTOR_ONE_MINUS_SRC_ALPHA,
        vk::BlendFactor::eOneMinusSrcAlpha,
  //       vk::_BLEND_FACTOR_SRC_ALPHA,
        vk::BlendOp::eAdd,
    ...
    //Device* device_maker::create(const std::string &name) {
...
//           YAVF_INFO_REPORT(("Version: "+vk::_VERSION_TO_STRING(e.specVersion)).c_str())
//         }
//       }
